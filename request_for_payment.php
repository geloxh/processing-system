...
<head>
    ...
    <link rel="stylesheet" href="/processing-system/public/css/payment_request.css">
</head>
<body>

<h2>Request for Payment Form</h2>

<form method="POST" action="/processing-system/public/submit-payment_request">
    ...
    <input type="text" name="receive_by">
